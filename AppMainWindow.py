...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addLayout(self.gridLayout_accessories_list, 1, 0, 1, 1)
        ...
        self.pushButton_generate.setGeometry(QtCore.QRect(750, 270, 171, 61))
        self.pushButton_generate.setObjectName("pushButton_generate")
        self.pushButton_folder = QtWidgets.QPushButton(self.tab)
        self.pushButton_folder.setGeometry(QtCore.QRect(720, 140, 131, 41))
